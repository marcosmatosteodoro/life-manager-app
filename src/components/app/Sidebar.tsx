...
const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/dividas', label: 'debts', Icon: HandCoinIcon },
    ],
  },
  {
    label: 'groupAboutMe',
    items: [
      ...
      { href: '/problemas', label: 'problems', Icon: TargetIcon },
    ],
  },
  {
    label: 'groupDogs',
...
function HandCoinIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" {...props}>
      <circle cx="16" cy="6" r="3" />
      <path d="M2 14h6l3 2c1 .7 2.3.6 3-.2l4-3.6a1.5 1.5 0 0 0-2-2.2L14 13" />
      <path d="M2 12v7" />
    </svg>
  );
}
